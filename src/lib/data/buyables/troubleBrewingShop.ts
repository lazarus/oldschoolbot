...
export const troubleBrewingBuyables: Buyable[] = [
	{
		...
		itemCost: new Bank().add('Pieces of eight', 1000)
	},
	{
		name: 'Blue tricorn hat',
		itemCost: new Bank().add('Pieces of eight', 500)
	},
	{
	...
	{
		name: 'Cutthroat flag',
		itemCost: new Bank().add('Pieces of eight', 2000)
	},
	{
	...
	},
	{
		...
		itemCost: new Bank().add('Pieces of eight', 3000)
	},
	{
		name: 'Lucky shot flag',
		itemCost: new Bank().add('Pieces of eight', 4000)
	},
	{
		name: 'Treasure flag',
		itemCost: new Bank().add('Pieces of eight', 5000)
	},
	{
		name: 'Phasmatys flag',
		itemCost: new Bank().add('Pieces of eight', 6000)
	},
	{
		name: 'The stuff',
		itemCost: new Bank().add('Pieces of eight', 50)
	},
	{
		name: 'Red rum (trouble brewing)',
		itemCost: new Bank().add('Pieces of eight', 20)
	},
	{
