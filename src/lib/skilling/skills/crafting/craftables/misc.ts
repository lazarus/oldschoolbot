...
const Misc: Craftable[] = [
	{
		...
		level: 26,
		xp: 55,
		inputItems: new Bank().add('Jute fibre', 2),
		tickRate: 3
	},
	{
		...
		level: 45,
		xp: 30,
		inputItems: new Bank().add('Snakeskin', 6),
		tickRate: 3
	},
	{
		...
		level: 47,
		xp: 35,
		inputItems: new Bank().add('Snakeskin', 8),
		tickRate: 3
	},
	{
		...
		level: 48,
		xp: 45,
		inputItems: new Bank().add('Snakeskin', 5),
		tickRate: 3
	},
	{
		...
		level: 51,
		xp: 50,
		inputItems: new Bank().add('Snakeskin', 12),
		tickRate: 3
	},
	{
		name: 'Snakeskin body',
		...
		level: 53,
		xp: 55,
		inputItems: new Bank().add('Snakeskin', 15),
		tickRate: 3
	},
	{
		...
		level: 56,
		xp: 100,
		inputItems: new Bank().add('Snakeskin', 2).add('Willow shield', 1).add('Iron nails', 15),
		tickRate: 5
	},
	{
		name: 'Xerician hat',
		...
		level: 14,
		xp: 66,
		inputItems: new Bank().add('Xerician fabric', 3),
		tickRate: 3
	},
	{
		name: 'Xerician robe',
		...
		level: 17,
		xp: 88,
		inputItems: new Bank().add('Xerician fabric', 4),
		tickRate: 3
	},
	{
		name: 'Xerician top',
		...
		level: 22,
		xp: 110,
		inputItems: new Bank().add('Xerician fabric', 5),
		tickRate: 3
	},
	{
		...
		level: 1,
		xp: 34,
		inputItems: new Bank().add('Arctic pine logs', 2).add('Bronze nails', 1),
		tickRate: 3,
		qpRequired: 4,
		wcLvl: 56
	},
	{
		...
		level: 54,
		xp: 100,
		inputItems: new Bank().add('Battlestaff', 1).add('Water orb', 1),
		tickRate: 2
	},
	{
		...
		level: 58,
		xp: 112.5,
		inputItems: new Bank().add('Battlestaff', 1).add('Earth orb', 1),
		tickRate: 2
	},
	{
		...
		level: 62,
		xp: 125,
		inputItems: new Bank().add('Battlestaff', 1).add('Fire orb', 1),
		tickRate: 2
	},
	{
		...
		level: 66,
		xp: 137.5,
		inputItems: new Bank().add('Battlestaff', 1).add('Air orb', 1),
		tickRate: 2
	},
	{
		name: 'Ball of wool',
		...
		level: 1,
		xp: 2.5,
		inputItems: new Bank().add('Wool', 1),
		tickRate: 3
	},
	{
		name: 'Bow string',
		...
		level: 10,
		xp: 15,
		inputItems: new Bank().add('Flax', 1),
		tickRate: 3
	},
	{
		...
		level: 10,
		xp: 15,
		inputItems: new Bank().add('Sinew', 1),
		tickRate: 3
	},
	{
		name: 'Crossbow string',
	...
	},
	{
		...
		level: 8,
		xp: 15,
		inputItems: new Bank().add('Steel bar', 1),
		tickRate: 3
	},
	{
		...
		level: 83,
		xp: 60,
		inputItems: new Bank().add('Amethyst', 1),
		tickRate: 2,
		outputMultiple: 15
	},
	{
