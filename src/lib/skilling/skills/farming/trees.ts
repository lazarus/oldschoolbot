...
const trees: Plant[] = [
	{
		...
		inputItems: new Bank().add('Acorn').freeze(),
		...
		protectionPayment: new Bank().add('Tomatoes(5)').freeze(),
		woodcuttingXp: 37.5,
	...
	},
	{
		...
		inputItems: new Bank().add('Willow seed').freeze(),
		...
		protectionPayment: new Bank().add('Apples(5)').freeze(),
		woodcuttingXp: 67.5,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		inputItems: new Bank().add('Maple seed').freeze(),
		...
		protectionPayment: new Bank().add('Oranges(5)').freeze(),
		woodcuttingXp: 100,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		inputItems: new Bank().add('Yew seed').freeze(),
		...
		protectionPayment: new Bank().add('Cactus spine', 10).freeze(),
		woodcuttingXp: 175,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		inputItems: new Bank().add('Magic seed').freeze(),
		...
		chance99: 0,
		chanceOfDeath: 8 / 128,
		protectionPayment: new Bank().add('Coconut', 25).freeze(),
		woodcuttingXp: 250,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
