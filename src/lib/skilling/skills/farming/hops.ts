...
const hopsPlants: Plant[] = [
	{
		...
		checkXp: 0,
		harvestXp: 9.5,
		inputItems: new Bank().add('Barley seed', 4).freeze(),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank().add('Compost', 3).freeze(),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 10,
		inputItems: new Bank().add('Hammerstone seed', 4).freeze(),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank().add('Marigolds', 1),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 12,
		inputItems: new Bank().add('Asgarnian seed', 4).freeze(),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 14.5,
		inputItems: new Bank().add('Jute seed', 3).freeze(),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank().add('Barley malt', 6).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 16,
		inputItems: new Bank().add('Yanillian seed', 4).freeze(),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank().add('Tomatoes(5)', 200).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 19.5,
		inputItems: new Bank().add('Krandorian seed', 4).freeze(),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank().add('Cabbages(10)', 3).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 26,
		inputItems: new Bank().add('Wildblood seed', 4).freeze(),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank().add('Nasturtiums').freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
