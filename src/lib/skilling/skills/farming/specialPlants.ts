...
const specialPlants: Plant[] = [
	{
		...
		checkXp: 0,
		harvestXp: 47,
		inputItems: new Bank().add('Marigold seed').freeze(),
	...
	},
	{
		...
		checkXp: 64,
		harvestXp: 4.5,
		inputItems: new Bank().add('Redberry seed').freeze(),
		...
		protectionPayment: new Bank().add('Cabbage', 20).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 66.5,
		inputItems: new Bank().add('Rosemary seed').freeze(),
	...
	},
	{
		...
		checkXp: 102.5,
		harvestXp: 7,
		inputItems: new Bank().add('Cadavaberry seed').freeze(),
		...
		chance99: 154.9,
		chanceOfDeath: 17, // needs data
		protectionPayment: new Bank().add('Tomato', 15).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 21,
		inputItems: new Bank().add('Seaweed spore').freeze(),
		...
		chance99: 208,
		chanceOfDeath: 20,
		protectionPayment: new Bank().add('Numulite', 200).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 111,
		inputItems: new Bank().add('Nasturtium seed').freeze(),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 115.5,
		inputItems: new Bank().add('Woad seed').freeze(),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 120,
		inputItems: new Bank().add('Limpwurt seed').freeze(),
	...
	},
	{
		...
		checkXp: 7290,
		harvestXp: 0,
		inputItems: new Bank().add('Teak seed').freeze(),
		...
		chance99: 0,
		chanceOfDeath: 15,
		protectionPayment: new Bank().add('Limpwurt root', 15).freeze(),
		woodcuttingXp: 85,
	...
	},
	{
		...
		checkXp: 625,
		harvestXp: 40,
		inputItems: new Bank().add('Grape seed').add('Saltpetre').freeze(),
	...
	},
	{
		...
		checkXp: 177.5,
		harvestXp: 12,
		inputItems: new Bank().add('Dwellberry seed').freeze(),
		...
		chance99: 154.9,
		chanceOfDeath: 17, // needs data
		protectionPayment: new Bank().add('Strawberry', 15).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 284.5,
		harvestXp: 19,
		inputItems: new Bank().add('Jangerberry seed').freeze(),
		...
		chance99: 154.9,
		chanceOfDeath: 17, // needs data
		protectionPayment: new Bank().add('Watermelon', 6).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 57.7,
		inputItems: new Bank().add('Mushroom spore').freeze(),
	...
	},
	{
		...
		checkXp: 374,
		harvestXp: 25,
		inputItems: new Bank().add('Cactus seed').freeze(),
		...
		chance99: 178.2,
		chanceOfDeath: 15,
		protectionPayment: new Bank().add('Cadava berries', 6).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 15_720,
		harvestXp: 0,
		inputItems: new Bank().add('Mahogany seed').freeze(),
		...
		chance99: 0,
		chanceOfDeath: 12,
		protectionPayment: new Bank().add('Yanillian hops', 25).freeze(),
		woodcuttingXp: 125,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 250,
		inputItems: new Bank().add('White lily seed').freeze(),
	...
	},
	{
		...
		checkXp: 437.5,
		harvestXp: 29,
		inputItems: new Bank().add('Whiteberry seed').freeze(),
		...
		chance99: 154.9,
		chanceOfDeath: 15,
		protectionPayment: new Bank().add('Mushroom', 8).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 512,
		inputItems: new Bank().add('Belladonna seed').freeze(),
	...
	},
	{
		...
		checkXp: 230,
		harvestXp: 68,
		inputItems: new Bank().add('Potato cactus seed').freeze(),
		...
		chance99: 154.9,
		chanceOfDeath: 12,
		protectionPayment: new Bank().add('Snape grass', 8).freeze(),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 12_600,
		harvestXp: 0,
		inputItems: new Bank().add('Hespori seed').freeze(),
		name: 'Hespori',
		aliases: ['hespori'],
		petChance: 7000,
		seedType: 'hespori',
	...
	},
	{
		...
		checkXp: 675,
		harvestXp: 45,
		inputItems: new Bank().add('Poison ivy seed').freeze(),
	...
	},
	{
		...
		checkXp: 12_096,
		harvestXp: 48.5,
		inputItems: new Bank().add('Calquat tree seed').freeze(),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank().add('Poison ivy berries', 8).freeze(),
		needsChopForHarvest: true,
		fixedOutput: true,
		fixedOutputAmount: 6,
		givesLogs: false,
	...
	},
	{
		...
		checkXp: 13_240,
		harvestXp: 0,
		inputItems: new Bank().add('Crystal acorn').freeze(),
	...
	},
	{
		...
		checkXp: 19_301,
		harvestXp: 0,
		inputItems: new Bank().add('Spirit seed').freeze(),
		treeWoodcuttingLevel: 1,
		name: 'Spirit tree',
	...
	},
	{
		...
		checkXp: 14_130,
		harvestXp: 23.5,
		inputItems: new Bank().add('Celastrus seed').freeze(),
		...
		chance99: 63,
		chanceOfDeath: 15,
		protectionPayment: new Bank().add('Potato cactus', 8).freeze(),
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 22_450,
		harvestXp: 0,
		inputItems: new Bank().add('Redwood tree seed').freeze(),
		...
		chance99: 0,
		chanceOfDeath: 8,
		protectionPayment: new Bank().add('Dragonfruit', 6).freeze(),
		woodcuttingXp: 380,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
