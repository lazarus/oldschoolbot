...
const herbPlants: Plant[] = [
	{
		...
		inputItems: new Bank().add('Guam seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Marrentill seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Tarromin seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Harralander seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Ranarr seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Toadflax seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Irit seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Avantoe seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Kwuarm seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Snapdragon seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Cadantine seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Lantadyme seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Dwarf weed seed').freeze(),
	...
	},
	{
		...
		inputItems: new Bank().add('Torstol seed').freeze(),
